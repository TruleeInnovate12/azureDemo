...
const Contact = ({ sharingPermissions, objectPermissions }) => {
    ...
    <>
      ...
      <div className="fixed left-0 right-0 mx-auto z-10 sm:top-48 md:top-56 lg:top-56 xl:top-56 2xl:top-56">
        {tableVisible && (
          <div>
            {viewMode === "list" ? (
              <div className="sm:hidden md:hidden lg:flex xl:flex 2xl:flex text-sm">
                <div
                              ...
                              <td colSpan="8" className="py-10 text-center">
                                <div className="flex flex-col items-center justify-center p-5">
                                  ...
                                  <p className="text-center text-lg font-normal">
                                    You don't have contacts yet. Create new
                                    contact.
                                  </p>
                                  <p
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-4 px-4">
                          {loading ? (
                            ...
                            currentFilteredRows.map((contact) => (
                              <div key={contact._id} className="bg-white border border-custom-blue shadow-md p-2 rounded">
                                <div className="relative">
                                ...
                                <div className="flex">
                                  ...
                                  <div className="flex flex-col">
                                    <div className="text-custom-blue text-lg cursor-pointer break-words"  onClick={() => handleContactClick(contact)}>
                                      {contact.Name}
                                    </div>
                                    <div className="text-xs grid grid-cols-2 gap-2 items-start">
                                      <div className="text-gray-400">Current Role</div>
                                      <div>{contact.CurrentRole}</div>
                                      <div className="text-gray-400">Industry</div>
                                      <div>{contact.industry}</div>
                                      <div className="text-gray-400">Experience</div>
                                      <div>{contact.Experience}</div>
                                      <div className="text-gray-400">Linkedin URL</div>
                                      <div>
                                        <a href={contact.LinkedinUrl} target="_blank" rel="noopener noreferrer">{contact.LinkedinUrl}</a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
