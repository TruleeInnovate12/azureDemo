...
const AddQuestion1 = React.forwardRef(({ isOpen, onClose, sectionName, onQuestionAdded, selectedAssessmentType, selectedQuestion, onSave, updateQuestionList,isFromProfileDetails,assessment,sectionId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Question ID:", selectedQuestion._id);
